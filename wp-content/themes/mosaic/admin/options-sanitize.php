...
function of_sanitize_background( $input ) {
	...
	$output['image'] = apply_filters( 'of_sanitize_upload', ( array_key_exists( 'image', $input ) ) ? $input['image'] : '' );
	$output['repeat'] = apply_filters( 'of_background_repeat', ( array_key_exists( 'repeat', $input ) ) ? $input['repeat'] : '' );
	$output['position'] = apply_filters( 'of_background_position', ( array_key_exists( 'position', $input ) ) ? $input['position'] : '' );
	$output['attachment'] = apply_filters( 'of_background_attachment', ( array_key_exists( 'attachment', $input ) ) ? $input['attachment'] : '' );
...
function of_sanitize_typography( $input, $option ) {
	...
	$output['mosaic_yle'] = apply_filters( 'of_font_style', $output['style'] );
...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => __('No Repeat', 'mosaic'),
		'repeat-x'  => __('Repeat Horizontally', 'mosaic'),
		'repeat-y'  => __('Repeat Vertically', 'mosaic'),
		'repeat'    => __('Repeat All', 'mosaic'),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => __('Top Left', 'mosaic'),
		'top center'    => __('Top Center', 'mosaic'),
		'top right'     => __('Top Right', 'mosaic'),
		'center left'   => __('Middle Left', 'mosaic'),
		'center center' => __('Middle Center', 'mosaic'),
		'center right'  => __('Middle Right', 'mosaic'),
		'bottom left'   => __('Bottom Left', 'mosaic'),
		'bottom center' => __('Bottom Center', 'mosaic'),
		'bottom right'  => __('Bottom Right', 'mosaic')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => __('Scroll Normally', 'mosaic'),
		'fixed'  => __('Fixed in Place', 'mosaic')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => __('Normal', 'mosaic'),
		'italic'      => __('Italic', 'mosaic'),
		'bold'        => __('Bold', 'mosaic'),
		'bold italic' => __('Bold Italic', 'mosaic')
		);
