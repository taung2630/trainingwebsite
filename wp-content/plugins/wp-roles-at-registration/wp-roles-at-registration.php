...
function load_manage_allowed_roles_form_js() {
...
class WPRolesAtRegistration {
  ...
  function WPRolesAtRegistration() {
...
function wp_rar_admin_menu() {
  ...
  add_options_page('WP Roles at Registration', 'WP Roles at Registration', 9, 'wp-roles-at-registration', array($wp_rar_plugin, 'manage_allowed_roles_form'));
}
...
add_action('admin_print_scripts-settings_page_wp-roles-at-registration', 'load_manage_allowed_roles_form_js');
?>
